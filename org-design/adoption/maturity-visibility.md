...
## Integration
- **Evolution auditor** tracks level changes over time in the monthly governance review. The `Adoption Maturity Tracking` table in each evolution audit references this ladder.
- **Adoption sprint designer** reads the current maturity ladder to identify participants, barriers, and buddy pairings for upcoming sprints.
