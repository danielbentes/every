...
> Sources: 23 URLs from every.to (21 successfully fetched; 2 returned 404/paywall)

---

## Table of Contents

1. [Every's Master Plan: Part II](#1-everys-master-plan-part-ii)
2. [Every's Master Plan](#2-everys-master-plan)
3. [2025 Year in Review](#3-2025-year-in-review)
4. [Every 2024: The Year in Every](#4-every-2024-the-year-in-every)
5. [Introducing Every Consulting](#5-introducing-every-consulting)
6. [The Next Chapter of Every Consulting](#6-the-next-chapter-of-every-consulting)
7. [Brandon Gell Joins Every as First Entrepreneur in Residence](#7-brandon-gell-joins-every-as-first-entrepreneur-in-residence)
8. [Kate Lee Joins Every as Editor-in-Chief](#8-kate-lee-joins-every-as-editor-in-chief)
9. [Introducing Plus One: One-Click OpenClaw Agents by Every](#9-introducing-plus-one-one-click-openclaw-agents-by-every)
10. [Introducing Proof](#10-introducing-proof)
11. [Go Agent-Native with Every](#11-go-agent-native-with-every)
12. [What Comes Next: A New Era for Every](#12-what-comes-next-a-new-era-for-every)
13. [Introducing Every Studio](#13-introducing-every-studio)
14. [So We Raised Some Money](#14-so-we-raised-some-money)
15. [Austin Tedesco Joins Every as Head of Growth](#15-austin-tedesco-joins-every-as-head-of-growth)
16. [Introducing Spiral v3: An AI Writing Partner with Taste](#16-introducing-spiral-v3-an-ai-writing-partner-with-taste)
17. [Every's Q4 Demo Day (Paywalled/404)](#17-everys-q4-demo-day)
18. [This Is How the Every Editorial Team Uses AI](#18-this-is-how-the-every-editorial-team-uses-ai)
19. [I Talked to More Than 100 Companies About AI](#19-i-talked-to-more-than-100-companies-about-ai)
20. [How Every Uses AI (404)](#20-how-every-uses-ai)
21. [Consulting Page](#21-consulting-page)
22. [About Page](#22-about-page)
23. [Agent-Native Architectures Guide](#23-agent-native-architectures-guide)
...
| Agent Name | Manager | Role |
|-----------|---------|------|
| R2-C2 | Dan Shipper (CEO) | Bug triage, article co-authoring, feature request collection |
| Iris | Anukshi Mittal (Product Marketing Lead) | Event scheduling, copy generation, product launch ops |
| Montaigne | Austin Tedesco (Head of Growth) | Email campaign optimization, landing page creation |
| Margot | Katie Parrott (Staff Writer/AI Editorial Lead) | Content pipeline management, editorial workflows |
| Alfredo | Lucas Crespo (Creative Director) | Visual system design, brand asset creation |
| Milo | Brandon Gell (CTO) | Waitlist user onboarding, research task management |
| Nettle | Kate Chapman (External Beta User) | Facebook content workflows, strategy optimization |
...
**Status:** Returned 404. No substantive data extracted.
...
| Date | Metric | Value |
|------|--------|-------|
| 2020-2024 | Total revenue since founding | $3+ million |
| Sep 2024 | Monthly recurring revenue (MRR) | $60,000 |
| Sep 2024 | Paid subscribers | ~4,000 |
| Jul 2024 | MRR growth | 8% over 45 days |
| May 2025 | Funding raised | $2 million (Reid Hoffman, StartingLine, Walleye Capital) |
| Sep 2025 | Annual recurring revenue (ARR) | ~$1.2 million |
| Sep 2025 | ARR growth | 15% month-over-month (trailing 3 months) |
| 2025 | Consulting revenue | Seven-figure business (projected $1-2M annually) |
| Pre-2025 | Initial funding from Sahil Lavingia | $150,000 |

### Team Growth Timeline
| Date | Team Size | Notes |
|------|-----------|-------|
| Sep 2024 | 7 full-time | Plus 20-30 contractors |
| Late 2024 | 9 full-time | Plus 20-30 contractors |
| Sep 2025 | 15 full-time | Including consulting division |

### Subscriber Growth
| Date | Subscribers |
|------|------------|
| Oct 2023 | 90,000+ |
| Late 2024 | 85,000+ (paid focus) |
| 2025-2026 | 100,000+ |
...
|------|-----------|
| Dan Shipper | CEO and Cofounder |
| Brandon Gell | CTO (formerly COO, EIR); Head of Studio |
| Kate Lee | Editor-in-Chief and General Manager |
| Natalia Quintero | Head of Consulting |
| Austin Tedesco | Head of Growth |
...
| Willie Williams | Head of Platform |
| Evan Armstrong | Lead Writer / Columnist (Napkin Math) |
| Katie Parrott | Staff Writer, AI Editorial Lead |
| Lucas Crespo | Creative Director |
| Anukshi Mittal | Product Marketing Lead |
| Eleanor Warnock | Managing Editor |
...
| Rachel Braun | Podcast Producer (AI & I) |
| Anthony Scarpulla | Social Media Manager |
| Brooker Belcourt | Finance Vertical Lead, Consulting |
| Avishek | Engineer |
| Andrey | Engineer |
| Kieran Klaassen | EIR (serial entrepreneur) |
| Edmar Ferreira | EIR (founder, EverWrite) |
| Cassius Kiani | EIR (nonprofit founder) |
| Dorothy Ren | Hacker in Residence |
| Nathan Baschez | Former Cofounder (now running Lex independently) |
